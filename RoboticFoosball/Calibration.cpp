...
bool actually_findChessboardCorners(Mat& frame, Size& size, Mat& corners, int flags) {
	...
	CvMat _image = frame;
	bool ok = cvFindChessboardCorners(&_image, size, reinterpret_cast<CvPoint2D32f*>(corners.data),	&count, flags) > 0;
	return ok;
}
...
int main()
{
	...
	while (successes<numBoards)
	{
		...
		//bool found = actually_findChessboardCorners(image, board_sz, pointBuf, CALIB_CB_ADAPTIVE_THRESH | CALIB_CB_FAST_CHECK | CALIB_CB_NORMALIZE_IMAGE);
...
//	//! [file_read]
//	Settings s;
//	const string inputSettingsFile = argc > 1 ? argv[1] : "C:/Users/Imran/Desktop/Design/RoboticFoosball/RoboticFoosball/default.xml";
...
//		int chessBoardFlags = CV_CALIB_CB_ADAPTIVE_THRESH | CV_CALIB_CB_FILTER_QUADS;
//
//		if (!s.useFisheye) {
